...
// Your goal in this kata is to determine which phrase the girls would say at the last petal for a flower of a given number of
...
export function howMuchILoveYou(petals: number): string{
    ...
    const index: number = (petals - 1) % 6
    return phrases[index]
}

// This is a clever solution
export function howMuchILoveYouAgain(petals: number): string{
