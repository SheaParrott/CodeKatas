...
# with [0, 1] instead of [1, 1] basically shifts the common 
# Fibonacci sequence by once place, you may be tempted to think 
# that we would get the same sequence shifted by 2 places, but that
...
#  and for showing me this mathematical curiosity too with his
...
def tribonacci(signature,n)
  ...
  while new_array.length < n
    new_num = new_array[index] + new_array[index - 1] + new_array[index - 2]
    new_array << new_num
    index += 1
  end
