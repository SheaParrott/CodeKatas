...
// (the second number), and divide the coefficient by that new number (the first number).

// In 3x^2, for example, the integral would be 1x^3 (we added 1 to the exponent,
//   and divided the coefficient by that new number).

// integrate(3,2) // => "1x^3"
// integrate(9,5) // => "1.5x^6"
// Note that the output should be a string. The coefficient is always positive.
