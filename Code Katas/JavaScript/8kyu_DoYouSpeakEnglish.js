...
const spEng = sentence => (sentence.match(/english/i) ? true : false)

// best practice from solutions. I learned a interesting javascript method
// when using regex with this solution!
