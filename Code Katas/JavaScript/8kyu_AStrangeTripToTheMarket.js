...
// patterns of tunes. As you wonder what kind of algorithm you could use to shift octaves by
// 8 pitches or something silly like that, it dawns on you that you have been watching the
//  musician for some 10 odd minutes. You ask, "How much do people normally tip for something
//  like this?" The artist looks up. "Its always gonna be about tree fiddy."
...
//  a solution for finding The Loch Ness Monster. Note: It can also be written as 3.50 or three
//  fifty.

const isLockNessMonster = s => s.includes('tree fiddy') || s.includes('$3.50')

// best practice from solutions. Smart way to go about it. I need to remember to use the
// regex.test() solution
